...
class WorksTest < ApplicationSystemTestCase
  ...
  test "should create work" do
    ...
    fill_in "City", with: @work.city
    fill_in "Contact", with: @work.contact
    fill_in "Description", with: @work.description
    fill_in "Img", with: @work.img
    fill_in "Link", with: @work.link
    fill_in "Mini desc", with: @work.mini_desc
    fill_in "Name", with: @work.name
    fill_in "Qr", with: @work.qr
    fill_in "Salary", with: @work.salary
